...
authRouter.post('/launderers', (req,res,next)=>{
...
authRouter.get('/launderers', (req, res, next) => {
    User.find(
      {
        $and: [
          { isLaunderer: true },
...
authRouter.get('/launderers/:id', (req,res, next) =>
{
...
authRouter.post('/laundry-pickups', (req,res,next)=>{
    const pickupInfo = {
